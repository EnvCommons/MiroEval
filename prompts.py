"""
Prompt templates for MiroEval Pointwise Evaluation.

Faithfully reproduced from the original MiroEval implementation:
https://github.com/MiroMindAI/MiroEval/blob/main/point_quality/deepresearcharena/prompts/pointwise_prompts.py
"""
...
# ── Multimodal-specific prompts (for queries WITH attachments) ──
